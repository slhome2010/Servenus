...
$responce = array(
	...
	'news' => '<h4>Есть обновления!</h4> 
				<p class="lead">Версия 3.1.5.</p>
				<ul>
					<li>Предусмотрено удаление атрибутов категории из товара в момент отвязки товара от категории;</li>
					<li>Добавлена украинская локализация;</li>
					<li>Изменен алгоритм удаления дублей атрибутов;</li>
					<li>Изменен алгоритм дефрагментации;</li>
					<li>Исправлена ошибка объединения Дежурных шаблонов при слиянии атрибутов;</li>                   
				</ul>',

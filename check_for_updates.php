...
$responce = array(
	...
	'news' => '<h4>Есть обновления!</h4> 
				<p class="lead">Версия 3.1.3.</p>
				<ul>
				<li>Расширен функционал инструмента "Клонирование языков";</li>
					<li>Добавлено клонирование "Дежурного шаблона" во все языки через меню или горячие клавиши;</li>                    
				</ul>',

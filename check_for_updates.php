...
$responce = array(
	...
	'news' => '<h4>Есть обновления!</h4> 
				<p class="lead">Версия 3.1.4.</p>
				<ul>
				<li>Устранена критическая ошибка регистронезависимой выборки значений.
				Ошибка могла приводить к удалению значений в верхнем и нижнем регистре одновременно;</li>
					<li>Изменена синхронизация дерева Атрибуты категорий;</li>                    
				</ul>',
